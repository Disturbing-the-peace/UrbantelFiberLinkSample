    ...
    <div className="min-h-screen relative overflow-hidden bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          {/* ISP Application Referral */}
          <div className="bg-gradient-to-br from-teal-50 to-blue-50 dark:from-teal-900/20 dark:to-blue-900/20 p-6 rounded-2xl border border-teal-200 dark:border-teal-800 shadow-sm transition-colors duration-300">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white">ISP Application Link</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">Share with potential subscribers</p>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-3 mb-3">
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Your Referral Link</p>
              <p className="text-sm font-mono text-gray-900 dark:text-white break-all">
                {typeof window !== 'undefined' ? `${window.location.origin}/apply?ref=${agent.referral_code}` : ''}
              </p>
            </div>
            <button
              onClick={() => copyToClipboard(
                `${window.location.origin}/apply?ref=${agent.referral_code}`,
                'link'
              )}
              className="w-full px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-colors flex items-center justify-center gap-2 font-medium"
            >
              {copiedCode === `${window.location.origin}/apply?ref=${agent.referral_code}` ? (
                <>
          ...
          {/* Agent Hiring Referral */}
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-6 rounded-2xl border border-purple-200 dark:border-purple-800 shadow-sm transition-colors duration-300">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white">Agent Hiring Link</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">Recruit new agents</p>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-3 mb-3">
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Your Recruitment Link</p>
              <p className="text-sm font-mono text-gray-900 dark:text-white break-all">
                {typeof window !== 'undefined' ? `${window.location.origin}/apply-agent?ref=${agent.id}` : ''}
              </p>
            </div>
            <button
              onClick={() => copyToClipboard(
                `${window.location.origin}/apply-agent?ref=${agent.id}`,
                'link'
              )}
            ...
            >
              {copiedCode === `${window.location.origin}/apply-agent?ref=${agent.id}` ? (
                <>
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>

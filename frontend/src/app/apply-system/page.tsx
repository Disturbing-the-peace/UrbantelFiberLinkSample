...
function SystemApplicationFormContent() {
  // No agent referral needed for system applications
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(`${apiUrl}/api/customers/system-applications`, {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          ...
          // No agentRef - system application
          images,
        }),
      });
...
export default function SystemApplicationForm() {
  return (
    <SystemApplicationFormContent />
  );
}

      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full">
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 p-6 rounded-t-xl relative">
          <div className="flex items-center gap-3 text-white">
            ...
            <div>
              <h2 className="text-2xl font-bold">Delete Agent</h2>
          ...
          {step === 1 ? (
            <>
              ...
              <div className="mb-6">
                <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                  This agent will be removed from:
                </p>
                <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <li className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 bg-red-500 rounded-full"></div>
                    All applications and subscribers
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 bg-red-500 rounded-full"></div>
                    Commission records
            ...
            <>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-3 mb-6">
                <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Deleting agent:</p>
                <p className="text-sm font-mono text-gray-900 dark:text-gray-100">{agentName}</p>
              </div>
